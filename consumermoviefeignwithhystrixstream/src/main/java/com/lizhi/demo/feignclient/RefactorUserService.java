...
//@FeignClient(name = "provider-user", fallback = RefactorHystrixClientFallback.class)
//public interface RefactorUserService extends UserService {
//
//}

@FeignClient(name = "provider-user", fallbackFactory = RefactorHystrixClientFallback.class)
public interface RefactorUserService extends UserService {
